...
import com.util.refresh.internal.FlipLoadingLayout;
import com.util.refresh.internal.LoadingLayout;
import com.util.refresh.internal.RotateLoadingLayout;
import com.util.refresh.internal.Utils;
import com.util.refresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private boolean mOverScrollEnabled = true; //过量滚动 弹簧效果
    ...
    private final int resetDataDelayTime = 0;

    @Override
    public final void onRefreshComplete() {
        //		long time = REFRESHTIME - (System.currentTimeMillis() - mLastRefreshTime);
        //		if (time <= 0)
        //			time = 0;
        ...
        if (isRefreshing()) {
            ...
            handler.sendEmptyMessageDelayed(0, resetDataDelayTime);
        }
    }
    ...
    //	{
    //		getLoadingLayoutProxy(false, true).setPullLabel(getContext().getString(R.string.pull_to_refresh_from_bottom_pull_label));
    //		getLoadingLayoutProxy(false, true).setRefreshingLabel(getContext().getString(R.string.pull_to_refresh_from_bottom_refreshing_label));
    //		getLoadingLayoutProxy(false, true).setReleaseLabel(getContext().getString(R.string.pull_to_refresh_from_bottom_release_label));
    //	}
    ...
    final void setState(State state, final boolean... params) {
        ...
        switch (mState) {
            ...
            case OVERSCROLLING:
                ...
                //	this.getRefreshableView().requestFocus();
                //	setState(State.RESET);
                break;
        }
    ...
    protected void onReset() {
        ...
        //
        //			}
        //		}, getPullToRefreshScrollDuration()+50);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        //		mFooterLayout.setPullLabel("上拉加载...");
        //		mFooterLayout.setRefreshingLabel("正在加载...");
        //		mFooterLayout.setReleaseLabel("松开加载更多...");
    ...
    public static enum Orientation {
        VERTICAL, HORIZONTAL, OrientationHelper;
    }
